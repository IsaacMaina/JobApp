...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\isaac\\Documents\\NextJS\\job-app\\prisma\\generated\\prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/prisma/client\" // Assuming this is where your client is generated\n}\n\ndatasource db {\n  provider = \"postgresql\" // Assuming PostgreSQL, user can change this\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Account {\n  id                String  @id @default(cuid())\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String? @db.Text\n  access_token      String? @db.Text\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String? @db.Text\n  session_state     String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n}\n\nmodel Session {\n  id           String   @id @default(cuid())\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n}\n\nmodel User {\n  id            String    @id @default(cuid())\n  name          String?\n  email         String?   @unique\n  emailVerified DateTime?\n  image         String?\n  password      String? // Added for Credentials Provider\n  accounts      Account[]\n  sessions      Session[]\n  jobs          Job[] // Link User to Job\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String   @unique\n  expires    DateTime\n\n  @@unique([identifier, token])\n}\n\nmodel Job {\n  id          String   @id @default(cuid())\n  title       String\n  description String\n  location    String?\n  salary      Int?\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n  postedById  String // Foreign key to User (changed from userId)\n  postedBy    User     @relation(fields: [postedById], references: [id]) // Changed from user\n}\n",
  "inlineSchemaHash": "4d0b4dcc4e75145df5cde0b1a232fbf69e77739dc9587d9f4d4184f281d39cfe",
  "copyEngine": true
}
